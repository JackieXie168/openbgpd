...
rm -f Makefile.in aclocal.m4 compile configure config.status depcomp install-sh missing ltmain.sh libtool .built .configured configure.scan .prepared .version* *~
